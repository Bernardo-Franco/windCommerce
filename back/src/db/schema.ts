...
// cascade = "delte children when parent is deleted"; restrict = "don't delete the parent if any child still points at it."
...
// the same product can show up on may order lines
